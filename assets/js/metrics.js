 ...
 * BIP! API: GET https://bip-api.imsi.athenarc.gr/paper/scores/{encoded DOI} returns
 *   {doi, pop_class, inf_class, imp_class, cc_class, attrank, pagerank, 3_year_cc, cc} (verified 2026-09-22)
 */
(function () {
  'use strict';
  ...
  function fetchBip(doi) {
    /* BIP! requires the DOI slash percent-encoded: /paper/scores/10.1186%2Fs13059-... (a literal slash gives 404) */
    return fetch(BIP_API + encodeURIComponent(doi), { headers: { Accept: 'application/json' } })
